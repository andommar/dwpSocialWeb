      ...
      <?php include('views/admin/shared/admin-sidebar.php') ?>
        ...
        <?php 
          ...
          if(empty($args[1])) {
            ...
            if($args[1]== 'posts') {include('pages/admin-posts.php');
            } else if(!empty($args) && $args[1]== 'users') {include('pages/admin-users.php');
            } else if(!empty($args) && $args[1]== 'user') {include('pages/admin-edit-user.php');
            } else if(!empty($args) && $args[1]== 'comments') {include('pages/admin-comments.php');
            }
          }
        ?>
        </main>
