<nav id="admin-navbar" class="navbar navbar-dark bg-dark">
    <div class="col-md-2 my-2">
        <a href="home" id="home_icon" class="navbar-brand"><i class="fas fa-home"></i></a>
    </div>
    <div class="admin_navbar_links px-3">
        <div class="admin_navbar_profile d-flex align-items-center" id="user_profile">
            ...
            <a id="logout" href="logout/1" data-toggle="tooltip" data-placement="bottom"><i class="fas fa-sign-out-alt"></i></a>
        </div>
    </div>
</nav>